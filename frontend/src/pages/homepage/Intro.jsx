...
export default function Intro({ logoSrc, title, onFinish }) {
    ...
    useEffect(() => {
        ...
        const sleep = (ms) =>
            new Promise((res) =>
                setTimeout(res, skipRef.current ? ms / 2 : ms)
            );
        ...
        const playIntro = async () => {
            ...
            logo.style.animation =
                "logoLoop 1.8s ease-in-out infinite alternate";
            await sleep(800);
            ...
            overlay.style.transition =
                "background-color 400ms ease, backdrop-filter 400ms ease";
      ...
      `}</style>
            ...
            <div className="flex flex-col items-center gap-2 overflow-hidden">
                ...
                >
                    ...
                    <span className={`ml-1 cursor ${isTyping ? "blink" : ""}`}>
                        |
                    </span>
                </h1>
